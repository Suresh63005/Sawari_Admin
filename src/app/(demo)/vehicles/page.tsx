  ...
  try {
    const response = await apiClient.get("/v1/admin/vehicles", {
      params: {
        ...
        driver_id: driverId || undefined, // pass driver id to API
      },
    });
    ...
    setVehicles(data);
    setTotalItems(response.data.total); // total for filtered list
  } catch (err) {
...
useEffect(() => {
  ...
  const filteredVehicles = vehicles.filter((vehicle) => {
    ...
    const matchesDriverId = driverIdFilter
      ? vehicle.driver_id === driverIdFilter
      : true;
...
const currentVehicles = filteredVehicles; // no slicing at all
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                                  ...
                                  <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-2">
                                      ...
                                      <div className="space-y-1">
                                        ...
                                        <p className="text-sm">
                                          Verified By:{" "}
                                          {selectedVehicle.verified_by || "N/A"}
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                        ...
                        {vehicle.status !== "rejected" &&
                          !(
                            vehicle.is_approved && vehicle.status === "active"
                          ) && (
                            <Button
                              variant="outline"
                              size="sm"
