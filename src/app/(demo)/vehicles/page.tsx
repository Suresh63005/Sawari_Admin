      ...
      if (action === "rc-verify") {
        ...
        if (!reason) {
          toast({
            variant: "destructive",
            title: "Error",
            description: "A reason is required to reject the RC document"
          });
          return;
        }
        ...
        if (!reason) {
          toast({
            variant: "destructive",
            title: "Error",
            description: "A reason is required to reject the insurance document"
          });
          return;
        }
        await apiClient.post(
        ...
        <DialogContent>
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={
                confirmDialog.action.includes("reject") && !rejectReason
              }
            >
              {confirmDialog.action.includes("verify")
                ? "Verify"
